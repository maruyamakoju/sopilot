...
### [P1-5] Add tests for `nn/functional.py`
Shared tensor primitives (`softmin3`, `pairwise_euclidean_sq`, `pairwise_cosine_dist`) tested indirectly through callers but lack isolated unit tests.
...
### [P2-2] Add tests for `nn/constants.py`
Trivial module but a smoke test ensures constants haven't been accidentally changed.
