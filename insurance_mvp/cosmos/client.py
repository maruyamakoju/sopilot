...
class VideoLLMClient:
    ...
    def _mock_inference(self, prompt: str) -> str:
        ...
        if is_collision and not is_near_miss:
            scenario = self._mock_collision_scenario(rng)
        elif is_near_miss or (has_danger and is_pedestrian):
            scenario = self._mock_near_miss_scenario(rng)
        else:
            scenario = self._mock_normal_scenario(rng)

        hazards = self._mock_hazards(rng, is_collision, is_near_miss)
    ...
    @staticmethod
    def _mock_collision_scenario(rng) -> dict:
    ...
    @staticmethod
    def _mock_near_miss_scenario(rng) -> dict:
    ...
    @staticmethod
    def _mock_normal_scenario(rng) -> dict:
    ...
    @staticmethod
    def _mock_hazards(rng, is_collision: bool, is_near_miss: bool) -> list[dict]:
        if is_collision:
