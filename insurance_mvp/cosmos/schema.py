"""Insurance Domain Models for Video-LLM Assessment.

Pydantic models for insurance claim assessment, designed to be serialized
to/from JSON for Video-LLM structured output.
"""
...
class ClaimAssessment(BaseModel):
    """Complete insurance claim assessment from Video-LLM."""
...
def create_default_claim_assessment(video_id: str) -> ClaimAssessment:
    """Create default assessment with safe values for fallback scenarios.

    Returns an assessment with maximum uncertainty, requiring human review.
    """
