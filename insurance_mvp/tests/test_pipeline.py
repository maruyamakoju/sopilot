...
"""
    ...
    def test_merge_configs(self):
        ...
        base = {"output_dir": "base_dir", "log_level": "INFO", "mining": {"top_k_clips": 20}}
        override1 = {"log_level": "DEBUG", "mining": {"audio_weight": 0.5}}
        override2 = {"output_dir": "final_dir", "mining": {"top_k_clips": 10}}
...
"""
    ...
    def test_load_config_with_override(self):
        ...
        override = {"output_dir": "/tmp/override", "parallel_workers": 16}
    ...
    def test_save_config(self, temp_dir):
        ...
        config = PipelineConfig(output_dir="/tmp/save_test", log_level="ERROR", parallel_workers=8)
...
class TestInsurancePipeline:
    ...
    def test_metrics_tracking(self, default_config):
        ...
        result1 = VideoResult(
            video_id="v1", video_path="v1.mp4", success=True, danger_clips=[{}, {}], assessments=[Mock(), Mock()]
        )
        result2 = VideoResult(video_id="v2", video_path="v2.mp4", success=False, error_message="Test error")
    ...
    def test_save_results(self, default_config, temp_dir):
        ...
        json_path, html_path = pipeline._save_results(
            video_id="test_save", danger_clips=danger_clips, assessments=assessments
        )
    ...
    def _create_mock_assessment(self, severity: str, confidence: float, pred_set: set = None) -> ClaimAssessment:
        ...
        return ClaimAssessment(
            ...
            fault_assessment=FaultAssessment(
                fault_ratio=50.0, reasoning="Test", applicable_rules=[], scenario_type="test"
            ),
            fraud_risk=FraudRisk(risk_score=0.0, indicators=[], reasoning="Test"),
            hazards=[],
            evidence=[],
