...
class TestASFormerForward:
    def test_output_shapes(self):
        ...
        model = ASFormer(
            d_in=32, d_model=16, n_classes=2, n_heads=2, n_encoder_layers=3, n_decoder_layers=3, n_decoders=2
        )
    ...
    def test_gradient_flow(self):
        ...
        model = ASFormer(d_in=16, d_model=16, n_heads=2, n_encoder_layers=2, n_decoder_layers=2, n_decoders=1)
    ...
    def test_num_parameters(self):
        ...
        model = ASFormer(d_in=64, d_model=64, n_heads=4, n_encoder_layers=5, n_decoder_layers=5, n_decoders=2)
...
class TestASFormerLoss:
    ...
    def test_loss_decreases(self):
        ...
        model = ASFormer(d_in=8, d_model=8, n_heads=2, n_encoder_layers=2, n_decoder_layers=2, n_decoders=1)
        loss_fn = ASFormerLoss(n_classes=2)
...
class TestSaveLoad:
    def test_roundtrip(self, tmp_path):
        from sopilot.nn.asformer import ASFormer, load_asformer, save_asformer
